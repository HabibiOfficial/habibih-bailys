...
const makeNewsletterSocket = (config) => {
    ...
    const parseFetchedUpdates = async (node, type) => {
        ...
        return await Promise.all((0, WABinary_1.getAllBinaryNodeChildren)(child).map(async (messageNode) => {
            ...
            const views = parseInt(((_b = (_a = (0, WABinary_1.getBinaryNodeChild)(messageNode, 'views_count')) === null || _a === void 0 ? void 0 : _a.attrs) === null || _b === void 0 ? void 0 : _b.c) || 0) || 0;
            ...
            sock.ev.on('connection.update', ({ connection }) => {
                if (connection === 'open') {
                    ...
                    setTimeout(() => {
                        ...
                        runLoop();
                        activeInterval = setInterval(runLoop, 60000);
                    }, 15000);
